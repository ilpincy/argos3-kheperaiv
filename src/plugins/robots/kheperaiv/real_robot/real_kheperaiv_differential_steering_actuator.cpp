...
static Real KHEPERAIV_SPEED_CM_S_TO_PULSES       = 10.0 / KH4_SPEED_TO_MM_S;
...
void CRealKheperaIVDifferentialSteeringActuator::Do(Real f_elapsed_time) {
  kh4_set_speed(m_fCurrentVelocity[0] * KHEPERAIV_SPEED_CM_S_TO_PULSES,
		m_fCurrentVelocity[1] * KHEPERAIV_SPEED_CM_S_TO_PULSES,
		GetDSPic());
}
